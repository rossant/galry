...
class PaintManager(object):
    ...
    # ---------------------
    def add_visual(self, visual_class, *args, name='visual', **kwargs):
        ...
        self.get_visuals().append(visual_class(*args, **kwargs))
    ...
    def transform_view(self):
        ...
        for visual in self.get_visuals():
            if not visual.is_static:
                self.set_data(name=visual['name'], 
