...
class DashedPlotVisual(Visual):
    ...
    def initialize(self, position=None, color=None):
        ...
        self.add_uniform("color", data=color, ndim=4)
        ...
        self.add_attribute("coord_vs", ndim=1, data=coords)
        self.add_varying("coord", ndim=1)
...
class MyPaintManager(PaintManager):
    def initialize(self):
        ...
        self.add_visual(DashedPlotVisual, position=position)
